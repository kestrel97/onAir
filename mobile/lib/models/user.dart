...
class User {
  ...
  User.fromFirebaseUser(FirebaseUser user, String fcm_token, LatLng location)
      : name = (user.providerData[0].displayName != null) ? user.providerData[0].displayName : "",
        uid = user.uid,
        identifier = (user.providerData[0].email != null) ? user.providerData[0].email : user.providerData[0].phoneNumber,
        fcm_token = fcm_token,
        location = location;
}